...
const (
	PrincipalService_CreatePrincipal_FullMethodName = "/identity.PrincipalService/CreatePrincipal"
	PrincipalService_DeletePrincipal_FullMethodName = "/identity.PrincipalService/DeletePrincipal"
)
